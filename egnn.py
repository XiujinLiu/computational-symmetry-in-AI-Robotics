...
class E_GCL(nn.Module):
    ...
    def __init__(self, input_nf, output_nf, hidden_nf, edges_in_d=0, act_fn=nn.SiLU(), residual=True, attention=False, normalize=False, coords_agg='mean', tanh=False):
        ...
        self.epsilon = 1e-8
        edge_coords_nf = 1
        # self.downsample = nn.Conv2d(in_channels, out_channels, 3, 1)

        self.edge_mlp = nn.Sequential(
            nn.Linear(input_edge + edge_coords_nf + output_nf, hidden_nf),
            act_fn,
...
if __name__ == "__main__":
    ...
    # Initialize EGNN
    egnn = EGNN(in_node_nf=n_feat, hidden_nf=8, out_node_nf=3, in_edge_nf=1)
